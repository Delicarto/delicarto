...
function RestForm({initial,editId,user,onSaved,onCancel}){
  ...
  return(<div style={{background:P.card,borderRadius:20,padding:"28px 24px",border:`1.5px solid ${P.border}`}}>
    ...
    <div style={{display:"grid",gap:16}}>
      ...
      <div><label style={lb}>Tagesangebot (optional, nur Premium)</label><input style={is} placeholder="z.B. Heute: Große Pizza für 8,99€!" value={f.dailySpecial||""} onChange={e=>upd("dailySpecial",e.target.value)}/></div>
